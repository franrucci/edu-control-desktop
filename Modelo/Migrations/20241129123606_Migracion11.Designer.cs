...
namespace Modelo.Migrations
{
    ...
    [Migration("20241129123606_Migracion11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.Pago", b =>
                {
                    ...
                    b.Property<int>("ApellidoPagador")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entidades.TipoDePago", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TipoDePago");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("Entidades.TipoDeTarjeta", b =>
                {
                    b.Property<int>("TipoDeTarjetaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TipoDeTarjetaId"));
                    ...
                    b.HasKey("TipoDeTarjetaId");

                    b.ToTable("TiposDeTarjeta");
            ...
            modelBuilder.Entity("Entidades.Efectivo", b =>
                {
                    b.HasBaseType("Entidades.TipoDePago");
            ...
            modelBuilder.Entity("Entidades.Tarjeta", b =>
                {
                    ...
                    b.Property<int>("NumDeComprobante")
                        .HasColumnType("int");

                    b.Property<int>("TipoDeTarjetaId")
                        .HasColumnType("int");

                    b.HasIndex("TipoDeTarjetaId");
            ...
            modelBuilder.Entity("Entidades.Transferencia", b =>
                {
                    ...
                    b.Property<int>("NumDeTransferencia")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entidades.Tarjeta", b =>
                {
                    b.HasOne("Entidades.TipoDeTarjeta", "TipoDeTarjeta")
                        .WithMany("Tarjetas")
                        .HasForeignKey("TipoDeTarjetaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TipoDeTarjeta");
                });
